...
// ParseCapacities parses a human-readable capacity such as "1GB", "512KB", or "1.5MB".
// Units are binary (1024-based): B, KB/K, MB/M, GB/G, TB/T. A leading sign is allowed.
...
// UnmarshalJSON implements json.Unmarshaler. It accepts a JSON string in the
// same format as ParseCapacities, a JSON number of bytes, or null.
...
// MarshalJSON implements json.Marshaler by encoding c as a quoted String() value.
...
// UnmarshalYAML implements yaml.Unmarshaler by parsing a string in the same
// format as ParseCapacities.
...
// MarshalYAML implements yaml.Marshaler by encoding c as its String() value.
func (c Capacities) MarshalYAML() (interface{}, error) {
	return c.String(), nil
}

// StringToCapacityHookFunc returns a mapstructure.DecodeHookFunc that converts
// strings into Capacities using ParseCapacities.
